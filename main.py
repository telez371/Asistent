...
samplerate = int(sd.query_devices(device, 'input')['default_samplerate'])  # получаем частоту микрофона
...
def main():
    ...
    with sd.RawInputStream(samplerate=samplerate, blocksize=48000, device=device, dtype='int16',
